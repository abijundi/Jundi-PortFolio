  ...
  return (
    <div className="pt-[70px] pb-[50px] flex flex-wrap justify-center items-center md:gap-[35px] xl:gap-[50px]">
      <div className="card-style"
        ...
        <h2 className="card-h poppins-bold">Thumbnail Design</h2>
        <p className="card-p poppins">
      ...
      <div className="card-style"
        ...
        <h2 className="card-h poppins-bold">Social Media Design</h2>
        <p className="card-p poppins">
      ...
      <div className="card-style"
        ...
        <h2 className="card-h poppins-bold">Other Design</h2>
        <p className="card-p poppins">
